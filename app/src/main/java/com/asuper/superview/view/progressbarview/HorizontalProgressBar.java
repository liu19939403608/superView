package com.asuper.superview.view.progressbarview;
...
public class HorizontalProgressBar extends View {
    ...
    private void init() {
        ...
        roundRectRadius = dp2px(5);//矩形圆角半径
     ...
     * @param canvas 画布
     */
    private void drawText(Canvas canvas, float textString) {
        ...
        //文字绘制到整个布局的中心位置
        canvas.drawText("已投" + textString + "%", textRect.centerX(), baseline, textPaint);
    }
...
//                textString = formatNum(format2Int(value));
     ...
     * @return
     */
    public HorizontalProgressBar setProgressWithAnimation(String progress) {
        mProgress = Float.parseFloat(progress);
        initAnimation();
        return this;
    }
