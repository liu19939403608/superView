...
public class CircleProgressBarView extends View {
     ...
     * 进度条背景颜色
     */
    private int circleBgColor = 0xFFefefef;
    /**
     * 进度条颜色
     */
    private int progressColor = 0xFFFf5111;

    /**
     * 默认圆环的宽度
     */
    private int defaultStrokeWidth = 3;
    /**
     * 圆形背景画笔宽度
     */
...
//                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isDrawCenterProgressText) {
            drawCenterProgressText(canvas, mProgress + "%");
        }
    }
     ...
     * @return
     */
    public CircleProgressBarView setProgressWithAnimation(double progress) {
