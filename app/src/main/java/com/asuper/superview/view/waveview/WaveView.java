package com.asuper.superview.view.waveview;
 ...
 * <p>
 * 自定义进度(类似柱状图)HistogramView  这个里面修改线的颜色
 */
public class WaveView extends LinearLayout {
    ...
    private final int DEFAULT_ABOVE_WAVE_COLOR = Color.RED;//水波纹上面颜色
    private final int DEFAULT_BLOW_WAVE_COLOR = Color.RED;//水波纹下方颜色
